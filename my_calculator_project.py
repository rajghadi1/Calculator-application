...
btnsin= Button(screen,text='sin',font=('arial',15,'italic bold'),bd=8,padx=16,pady=22,activebackground='green',activeforeground='white',bg='powder blue',command=cmsin)
btnsin.grid(row=0,column=4)

btncos= Button(screen,text='cos',font=('arial',15,'italic bold'),bd=8,padx=16,pady=22,activebackground='green',activeforeground='white',bg='powder blue',command=cmcos)
btncos.grid(row=1,column=4)

btntan= Button(screen,text='tan',font=('arial',15,'italic bold'),bd=8,padx=16,pady=22,activebackground='green',activeforeground='white',bg='powder blue',command=cmtan)
btntan.grid(row=2,column=4)

btnsqrt= Button(screen,text='sqrt',font=('arial',15,'italic bold'),bd=8,padx=16,pady=22,activebackground='green',activeforeground='white',bg='powder blue',command=cmsqrt)
btnsqrt.grid(row=3,column=4)

btnlog= Button(screen,text='log',font=('arial',16,'italic bold'),bd=8,padx=16,pady=22,activebackground='green',activeforeground='white',bg='powder blue',command=cmlog)
